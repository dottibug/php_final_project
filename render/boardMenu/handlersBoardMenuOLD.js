...
import {renderDeleteBoardWarningOLD} from "./renderDeleteBoardWarningOLD.js";
// import {renderEditBoardFormOLD} from "../editBoardForm/renderEditBoardFormOLD.js";
...
export async function handleShowDeleteBoardWarning() {
    ...
    if (data.success) {
        ...
        renderDeleteBoardWarningOLD(boardTitle);
    }
}
