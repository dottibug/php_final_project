...
import {handleDeleteList} from "./handlersCreateBoard.js";

// Render starting board lists
export function renderCreateBoardLists(lists, lightboxForm, hasErrors = false, errMsg = '') {
