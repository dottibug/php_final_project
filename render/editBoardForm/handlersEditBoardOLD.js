import {renderEditBoardListsOLD} from "./renderEditBoardListsOLD.js";
import {fetchBoardsOLD} from "../../fetch/fetchBoardsOLD.js";
import {fetchCurrentBoardListsOLD} from "../../fetch/fetchCurrentBoardListsOLD.js";
...
//         renderEditBoardListsOLD(data.lists, listsContainer);
//     }
// }
//
// // EVENT: Delete list
    ...
    if (!data.success) {
        ...
        data.lists.forEach((list) => {
            if (list.hasError) {
                const listsContainer = document.getElementById('startingLists')
                listsContainer.innerHTML = '';
                renderEditBoardListsOLD(data.lists, listsContainer, true, list.message);
            }
        })
    }

    if (data.success) {
        await fetchBoardsOLD();
        await fetchCurrentBoardListsOLD();
        handleCloseLightbox();
    }
}