...
import {handleAddList, handleSaveBoardChanges} from "./handlersEditBoardOLD.js";

// import {handleAddList, handleCreateBoard} from "../createNewBoardForm/handlersCreateBoard.js";

export function renderEditBoardFormOLD(fields, lists) {
    // Lightbox
    ...
    renderEditBoardListsOLD(lists, lightboxForm);
