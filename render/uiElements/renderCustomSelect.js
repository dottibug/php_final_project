import {handleShowSelectMenu, handleOptionClick} from "./handlersCustomSelect.js";

export function renderCustomSelect(parentElement, label, options, defaultSelectionData, defaultSelectionText) {
    // Container
